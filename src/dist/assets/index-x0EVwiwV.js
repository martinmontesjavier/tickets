(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))e(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&e(l)}).observe(document,{childList:!0,subtree:!0});function s(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function e(t){if(t.ep)return;t.ep=!0;const o=s(t);fetch(t.href,o)}})();const f=[{id:"T002",autor:"Torrente",fecha:"2023-11-22",opinion:"¿Nos hacemos unas pajillas?"},{id:"T002",autor:"Batman",fecha:"2023-11-23",opinion:"Soy batman"},{id:"T002",autor:"Brad Pitt",fecha:"2023-11-25",opinion:"Gooooouuuuuurlami"}],b={template:`
    <div class="d-flex">
    ...
    `,script:()=>{i(),document.querySelector(".volver").addEventListener("click",()=>{document.querySelector("main").innerHTML=r.template,r.script()});function i(){let a="";f.filter(e=>e.id==r.idTicket).forEach(e=>{a+=`
            <div class="card p-3 mt-2">
              <h5 class="text-end">Autor: <span>${e.autor}</span><span class="ms-4">${e.fecha}</span></h5>
              <p>${e.opinion}</p>
            </div>
            `}),document.querySelector(".contendorComentarios").innerHTML=a}document.querySelector(".nuevoComentario")&&document.querySelector(".nuevoComentario").addEventListener("click",a=>{a.preventDefault();let s=document.querySelector("#usuarioComentario").value,e=document.querySelector("#fechaComentario").value.slice(0,10),t=document.querySelector("#textoComentario").value,o={id:r.idTicket,autor:s,fecha:e,opinion:t};f.push(o),console.log(f),i()})}};let d=[{codigo:"T001",fecha:"2023-11-28",aula:"Aula 101",grupo:"Grupo A",ordenador:"PC001",descripcion:"Problema con la conexión a Internet",alumno:"Juan Pérez",estado:"Pendiente"},{codigo:"T002",fecha:"2023-11-29",aula:"Aula 102",grupo:"Grupo B",ordenador:"PC002",descripcion:"Problema con el software de la computadora",alumno:"María González",estado:"Resuelto"},{codigo:"T003",fecha:"2023-11-30",aula:"Aula 103",grupo:"Grupo C",ordenador:"PC003",descripcion:"No se puede imprimir desde la impresora",alumno:"Carlos Rodríguez",estado:"Resuelto"},{codigo:"T004",fecha:"2023-12-01",aula:"Aula 104",grupo:"Grupo D",ordenador:"PC004",descripcion:"Problema con el proyector",alumno:"Ana López",estado:"Pendiente"},{codigo:"T005",fecha:"2023-12-02",aula:"Aula 105",grupo:"Grupo E",ordenador:"PC005",descripcion:"No se puede acceder a ciertas páginas web",alumno:"Pedro Martínez",estado:"Resuelto"}];const r={template:`
    <div class="d-flex">
    ...
    `,bdRepuesto:null,idTicket:null,rol:null,script:()=>{i();function i(){let a="",s="";r.rol=document.querySelector("#nombreUsuario").dataset.rol,console.log(r.rol),d.forEach(e=>{e.estado=="Pendiente"&&(a+=`
                  <tr>
                      <td>${e.codigo}</td>
                      <td>${e.fecha}</td>
                      <td>${e.aula}</td>
